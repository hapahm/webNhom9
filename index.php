...
<!-- Categories Section Begin - Danh mục sản phẩm - bắt đầu - Slider -->
<section class="categories">
    <div class="container">
        <div class="row">
            ...
            <!-- Slider danh mục sản phẩm - Categories -->
    ...
    <div class="container">
        <div class="row">
            <div class="col-lg-12">
                ...
                <!-- Danh mục các sản phẩm đặc trưng -->
        ...
        <!-- Từng sản phẩm - ảnh, tên, giá popup mua hàng -->
